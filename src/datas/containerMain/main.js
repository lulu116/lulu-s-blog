  ...
  content: `
      ...
      <div>
           ...
           的接口创建，其它都一样的原理。我们可以在工单中查看实例详情
            ...
            <p>JPasteNav子导航条</p>
            <img src="./static/project/jcomponents.jpg" class="books-img"/  >
            <p>JFooter页脚</p>
            <img src="./static/project/jcomponents1.jpg" class="books-img"/  >
          </div>
  `
}, {
  key: '4',
  content: `
      ...
      <div>
           ...
           的接口创建，其它都一样的原理。我们可以在工单中查看实例详情
            ...
            <p>CCardWrappercard包裹器</p>
            <img src="./static/project/ctable1.jpg" class="books-img"/  >
            <p>CDescriptionList描述列表</p>
            <img src="./static/project/ctable2.jpg" class="books-img"/  >
          </div>
  `
}, {
  key: '5',
  content: `
      ...
      <div>
           ...
           的接口创建，其它都一样的原理。我们可以在工单中查看实例详情
            ...
            <p>纵横学院前台课程详情</p>
            <img src="./static/project/jouav-service.jpg" class="books-img"/  >
            <p>认证流程-课程学习</p>
            <img src="./static/project/jouav-server1.jpg" class="books-img"/  >
             <p>纵横学院后台课程详情</p>
            <img src="./static/project/jouav-admin-course.jpg" class="books-img"/  >
            <p>纵横学院后台题库管理</p>
            <img src="./static/project/jouav-admin-course1.jpg" class="books-img"/  >
            <p>纵横学院后台课程库主页</p>
            <img src="./static/project/jouav-admin-course2.jpg" class="books-img"/  >
          </div>
  `
}]
export {
