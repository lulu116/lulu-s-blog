...
const projectMain = [{
  ...
  content: `
          ...
          <div>
            ...
            <img src="./static/project/dbaas_machine.jpg"/ >
            <p>
             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
             2. 实例管理是本系统最重要的部分，同时各功能也是围绕着实例进行的操作及管理。所有的实例都会依赖于某些机器，
             在创建时会选择当前内存下可用的机器，实例创建成功会在实例管理列表展示，且查看详情。
            </p>
            <img src="./static/project/dbaas_create.jpg"/ >
            <img src="./static/project/dbaas_instance.jpg"/ >
            <img src="./static/project/dbaas_instnace_detail.jpg"/ >
            <br/>
            <p>
             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
             3. 健康巡检是对节点各信息进行检测，我们的任务有自动执行的，也有手动执行的。对节点生成的报告可以查看详情。如:mysql的状态、cpu等。
            </p>
            <img src="./static/project/dbaas_report.jpg"/ >
            <p>
             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
             4. 备份对整条实例的备份记录，恢复将该实例恢复到备份初始时。
            </p>
            <img src="./static/project/dbaas_backup.jpg"/>
            <p>
             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            5. 性能分析可以对指定实例指定节点进行的分析与统计
            </p>
           <img src="./static/project/dbaas_fengxi.jpg"/>
          </div>
